...
| [EXP-003](./EXP-003-model-providers.md) | 어떤 chat/embedding provider가 품질·비용 조건을 충족하는가? | **Completed** (2026-09-02, chat gate 실패) | ADR-0006, [ADR-0012](../adr/0012-chat-provider-revalidation.md) |
